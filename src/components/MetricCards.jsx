...
import { Star, Eye, Zap, Activity, Skull, TrendingUp, GitFork, Users, Flame, Layers } from 'lucide-react';
...
export function MetricCards({ summary, username }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
      ...
      {/* 1. Total Stars */}
      <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800/80 rounded-2xl p-5 relative overflow-hidden group hover:border-cyan-500/50 transition-all">
      ...
      <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800/80 rounded-2xl p-5 relative overflow-hidden group hover:border-emerald-500/50 transition-all">
        ...
        <div className="w-full h-1.5 bg-slate-800 rounded-full overflow-hidden">
          <div
            className={`h-full transition-all ${
              portfolioHealthAvg > 80 ? 'bg-emerald-400' : portfolioHealthAvg > 60 ? 'bg-cyan-400' : 'bg-amber-400'
            }`}
      ...
      {/* 5. Portfolio Status Overview */}
      <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800/80 rounded-2xl p-5 relative overflow-hidden group hover:border-purple-500/50 transition-all">
        <div className="flex items-center justify-between mb-3">
