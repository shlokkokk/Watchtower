...
import { X, Bell, Send, CheckCircle2, AlertTriangle, ShieldCheck, Star, Flame, Skull, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="space-y-2">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-3.5 pr-10 py-2.5 text-xs font-mono text-cyan-300 focus:outline-none focus:border-cyan-500"
                />
                <button
                  type="button"
                  onClick={() => setShowWebhook(!showWebhook)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-300 p-1"
                  title={showWebhook ? "Mask URL" : "Reveal URL"}
                >
